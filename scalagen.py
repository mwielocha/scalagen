...
parser.add_argument('--sbt-version', metavar = 'sbt_version', help='sbt version', default = '1.1.4')
parser.add_argument('--scala-version', metavar = 'scala_version', help='scala version', default = '2.12.4')
parser.add_argument('--scalatest-version', metavar = 'scalatest_version', help='scalatest version', default = '3.0.5')
